<template>
    <p class="mt-4 mb-2 text-lg text-gray-500 dark:text-gray-400 transition-all duration-300">
        I can use...
    </p>
    <div class="flex gap-4">
        <a target="_blank" href="https://ja.vuejs.org/">
            <svg version="1.1" viewBox="0 0 261.76 226.69" xmlns="http://www.w3.org/2000/svg" class="w-7 h-7">
        ...
        <a target="_blank" href="https://nuxt.com/">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 298" class="w-7 h-7">
        ...
        <a target="_blank" href="https://fastapi.tiangolo.com/ja/">
            <svg fill="none" height="2500" width="2500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 154 154" class="w-7 h-7">
