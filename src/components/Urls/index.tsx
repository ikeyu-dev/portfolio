            ...
            <div className="flex justify-center items-center gap-4">
                <div>
                    <a
                        ...
                        className="text-gray-600 hover:text-gray-900 transition-all duration-100"
                    ...
                    >
                        <svg
                            ...
                            viewBox="0 0 512 512"
                            xmlSpace="preserve"
                            className="w-7 h-7 fill-current transition-all duration-100"
                        >
                ...
                <div>
                    <a
                        ...
                        className="text-gray-600 hover:text-gray-800 transition-all duration-100"
                        rel="noopener noreferrer"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            ...
                            xmlSpace="preserve"
                            className="h-7 w-7 fill-current transition-all duration-300"
                        >
                            <g fill="#3EA8FF">
                                <path
                                    className="st0"
